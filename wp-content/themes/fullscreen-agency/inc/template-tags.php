...
if ( ! function_exists( 'fullscreen_agency_posted_on' ) ) :
	...
	function fullscreen_agency_posted_on() {
		...
		$posted_on = sprintf(
			...
			esc_html_x( '%s', 'post date', 'fullscreen-agency' ),
...
if ( ! function_exists( 'fullscreen_agency_posted_by' ) ) :
	...
	function fullscreen_agency_posted_by() {
		$byline = sprintf(
			...
			esc_html_x( '%s', 'post author', 'fullscreen-agency' ),
	...
	function fullscreen_agency_entry_footer() {
		...
		if ( 'post' === get_post_type() ) {
			...
			if ( $categories_list ) {
				...
				printf( '<span class="cat-links">' . esc_html__( '%1$s', 'fullscreen-agency' ) . '</span>', $categories_list ); // WPCS: XSS OK.
			}
