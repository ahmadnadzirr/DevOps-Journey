...
class Fullscreen_Agency_Welcome {
	...
	?>
		<div id="cv-theme-message" class="updated fullscreen-agency-message">
			<a class="fullscreen-agency-message-close notice-dismiss" href="<?php echo esc_url( wp_nonce_url( remove_query_arg( array( 'activated' ), add_query_arg( 'fullscreen-agency-hide-notice', 'welcome' ) ), 'fullscreen_agency_hide_notices_nonce', '_fullscreen_agency_notice_nonce' ) ); ?>"><?php esc_html_e( 'Dismiss', 'fullscreen-agency' ); ?></a>
	...
	private function intro() {
		...
		<div class="fullscreen-agency-theme-info">
				...
				<h1> <?php echo esc_html( 'About ', 'fullscreen-agency' ).' '. esc_html( $theme_name ).' '.esc_html( $fullscreen_agency_theme_version ); ?> </h1>
		...
		<p class="fullscreen-agency-actions">
			...
			<a href="<?php echo esc_url( apply_filters( 'fullscreen_agency_pro_theme_url', 'http://demo.codevibrant.com/fullscreen-agency-landing/' ) ); ?>" class="button button-secondary docs" target="_blank"><?php esc_html_e( 'View Demo', 'fullscreen-agency' ); ?></a>
			...
			<a href="<?php echo esc_url( apply_filters( 'fullscreen_agency_pro_theme_url', 'https://wordpress.org/support/theme/fullscreen-agency/reviews/?filter=5' ) ); ?>" class="button button-secondary docs" target="_blank"><?php esc_html_e( 'Rate this theme', 'fullscreen-agency' ); ?></a>
		</p>
			...
			<div class="changelog point-releases">
				<div class="under-the-hood two-col">
					...
					<div class="col">
						...
						<p><a href="<?php echo esc_url( 'http://docs.codevibrant.com/fullscreen-agency/' ); ?>" class="button button-secondary" target="_blank"><?php esc_html_e( 'Documentation', 'fullscreen-agency' ); ?></a></p>
					</div>
